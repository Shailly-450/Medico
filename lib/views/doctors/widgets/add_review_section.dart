...
class _AddReviewSectionState extends State<AddReviewSection> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _buildCategoryRating('Bedside Manner', _bedsideMannerRating, (value) {
          setState(() {
            _bedsideMannerRating = value;
          });
        }),
        _buildCategoryRating('Expertise', _expertiseRating, (value) {
          setState(() {
            _expertiseRating = value;
          });
        }),
        _buildCategoryRating('Communication', _communicationRating, (value) {
          setState(() {
            _communicationRating = value;
          });
        }),
        _buildCategoryRating(
            'Treatment Effectiveness', _treatmentEffectivenessRating, (value) {
          setState(() {
  ...
  void _submitReview() {
    // Create review directly without form validation
