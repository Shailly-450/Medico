...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Widget _buildProfileCard(BuildContext context, dynamic profile, ProfileViewModel profileVM) {
    final textTheme = Theme.of(context).textTheme;
                      ...
                      onPressed: () async {
                        await showDialog(
                          ...
                          builder: (ctx) => _EditProfileDialog(
                            ...
                            onSave: (data) async {
                              final success = await profileVM.updateProfile(data);
  ...
  Widget _buildProfileSwitchModal(BuildContext context, ProfileViewModel profileVM, dynamic profile) {
    final textTheme = Theme.of(context).textTheme;
...
class _EditProfileDialog extends StatefulWidget {
  ...
  const _EditProfileDialog({Key? key, this.initialProfile, required this.onSave}) : super(key: key);
